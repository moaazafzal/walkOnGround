...
public class PopulationManager : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Box(new Rect(0, 0, 300, 300), "Stats", guiStyle);
        GUI.Label(new Rect(10, 75, 200, 30), "Gen: " + generation, guiStyle);
        GUI.Label(new Rect(10, 150, 200, 30), string.Format("Time: {0:0.00}", elapsed), guiStyle);
        GUI.Label(new Rect(10, 225, 200, 30), "Population: " + population.Count, guiStyle);
        GUI.EndGroup();
    }
